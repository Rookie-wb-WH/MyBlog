# Generated by Django 4.0.8 on 2022-10-20 08:41
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='BlogApp.avatars', verbose_name='用户头像')),
                ('collects', models.ManyToManyField(blank=True, to='BlogApp.articles', verbose_name='收藏的文章')),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to. A user will get all permissions granted to each of their groups.', related_name='user_set', related_query_name='user', to='auth.group', verbose_name='groups')),
                ('navs', models.ManyToManyField(blank=True, to='BlogApp.navs', verbose_name='收藏的网站')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('nid', models.AutoField(primary_key=True, serialize=False)),
                ('title', models.CharField(blank=True, max_length=32, null=True, verbose_name='标题')),
                ('article', models.ManyToManyField(to='BlogApp.articles', verbose_name='文章')),
            ],
            options={
        ...
        migrations.AddField(
            model_name='navs',
            name='tag',
            field=models.ManyToManyField(to='BlogApp.navtags', verbose_name='网站标签'),
        ),
        migrations.CreateModel(
            name='Moods',
            fields=[
                ...
                ('digg_count', models.IntegerField(default=0, verbose_name='点赞数')),
                ('avatar', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='BlogApp.avatars', verbose_name='心情的发布头像')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('avatar', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='BlogApp.avatars', verbose_name='心情的发布头像')),
                ('mood', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='BlogApp.moods', verbose_name='评论的心情')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('menu_url', models.ManyToManyField(help_text='可以多选，多选就会轮播', to='BlogApp.menuimg', verbose_name='菜单图片')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='BlogApp.articles', verbose_name='评论文章')),
                ('parent_comment', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='BlogApp.comment', verbose_name='是否是父评论')),
        ...
        migrations.AddField(
            model_name='articles',
            name='cover',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, to='BlogApp.cover', verbose_name='文章封面'),
        ),
        migrations.AddField(
            model_name='articles',
            name='tag',
            field=models.ManyToManyField(blank=True, to='BlogApp.tags', verbose_name='文章标签'),
        ),
    ]
